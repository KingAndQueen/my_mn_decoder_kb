...
tf.flags.DEFINE_integer("embedding_size", 100, "Embedding size for MemE2E embedding matrices.")
...
tf.flags.DEFINE_integer("rnn_neurons", 100, "the number of neurons in Seq2seq's one layer of RNN.")
